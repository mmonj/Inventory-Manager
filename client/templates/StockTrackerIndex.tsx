...
export function Template(_props: templates.StockTrackerIndex) {
  ...
  const qtToolCards: DashboardCardInfo[] = [
    ...
    },
    {
      ...
      description: "View a rep's schedule as a calendar. Schedule or unschedule service orders",
      href: reverse("survey_worker:qt_schedule"),
      icon: faCalendarAlt,
  ...
  const qtAdminCards: DashboardCardInfo[] = [
    ...
    },
    {
      ...
      description: "View schedule JSON data",
      href: reverse("survey_worker:qt_schedules_json"),
      icon: faCalendarAlt,
      buttonIcon: faCalendarCheck,
